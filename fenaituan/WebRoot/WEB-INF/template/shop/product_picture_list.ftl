...
$(function(){
	...
	$(".extra_field").click(function(){
		if($("#secondary").attr("checked")==true)
			$("#salesType").val("secondary");
		else
			$("#salesType").val("");
		if($("#outline").attr("checked")==true)
			$("#tradeType").val("outline");
		else
			$("#tradeType").val("");
	...
	<div class="body">
		...
		<div class="bodyRight">
			<form id="productListForm" action="${base}/shop/product!list.action" method="get">
				...
				<input type="hidden" id="salesType" name="condition.salesType" value="${condition.salesType}" />
				<input type="hidden" id="tradeType" name="condition.tradeType" value="${condition.tradeType}" />
				...
				<div class="operateBar">
					...
					<div class="middle">
						...
						<span class="separator">&nbsp;</span>
						<input class="extra_field" id="secondary" type="checkbox" <#if condition.salesType == "secondary">checked="checked" </#if> />二手
						&nbsp;
						<input class="extra_field" id="outline" type="checkbox" <#if condition.tradeType == "outline">checked="checked" </#if> />线下
					</div>
					<div class="right"></div>
				</div>
				<div class="blank"></div>
