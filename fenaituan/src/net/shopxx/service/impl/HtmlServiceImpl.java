...
public class HtmlServiceImpl implements HtmlService {
	...
	public Map<String, Object> getCommonData() {
		...
		commonData.put("pictureFriendLinkList",
				friendLinkService.getPictureFriendLinkList());
		commonData.put("textFriendLinkList",
				friendLinkService.getTextFriendLinkList());
	...
	public void indexBuildHtml() {
		...
		data.put("newProductList", productDao
				.getNewProductList(Product.MAX_NEW_PRODUCT_LIST_COUNT));
		List<ProductCategory> allProductCategory = productCategoryService
				.getAll();
		...
		for (ProductCategory productCategory : allProductCategory) {
			...
			bestProductMap.put(productCategory.getId(), productDao
					.getBestProductList(productCategory,
							Product.MAX_BEST_PRODUCT_LIST_COUNT));
			hotProductMap.put(productCategory.getId(), productDao
					.getHotProductList(productCategory,
							Product.MAX_HOT_PRODUCT_LIST_COUNT));
			newProductMap.put(productCategory.getId(), productDao
					.getNewProductList(productCategory,
