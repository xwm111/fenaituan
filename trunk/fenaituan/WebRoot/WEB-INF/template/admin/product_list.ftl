	...
	<div class="body">
		...
		<form id="listForm" action="product!list.action" method="post">
			<div class="operateBar">
				...
				<label>托管:</label>
				<select name="condition.trusteeship" id="trusteeship">
					<option value="" >
						所有状态
					</option>
					<option value="0" <#if condition.trusteeship == "0">selected="selected" </#if>>
						${action.getText("Trusteeship.unused")}
					</option>
					<option value="1" <#if condition.trusteeship == "1">selected="selected" </#if>>
						${action.getText("Trusteeship.processing")}
					</option>
					<option value="2" <#if condition.trusteeship == "2">selected="selected" </#if>>
						${action.getText("Trusteeship.received")}
					</option>
					<option value="3" <#if condition.trusteeship == "3">selected="selected" </#if>>
						${action.getText("Trusteeship.cancel")}
					</option>
				</select>
				<label>每页显示:</label>
