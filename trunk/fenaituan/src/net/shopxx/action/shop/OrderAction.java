...
@InterceptorRefs({
	@InterceptorRef(value = "token", params = {"excludeMethods", "info,list,listSecondary,view,process"}),
...
public class OrderAction extends BaseShopAction {
	...
	public String list() {
		...
		currentPage="order!list.action";
		return "list";
	}
	
	public String listSecondary() {
		pager = orderService.getSecondaryOrderPager(getLoginMember(), pager);
		currentPage="order!listSecondary.action";
