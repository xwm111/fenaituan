...
public class BaseAdminAction extends ActionSupport {
	...
	public void addCookie(String name, String value) throws UnsupportedEncodingException {
		...
		//cookie.setDomain("fenaituan.com");
	...
	public void removeCookie(String name) throws UnsupportedEncodingException {
		addCookie(name, "deleted");// deleted 可以是任意非空字段
	}
	...
	private void initCookie(){
		...
		for (int i = 0; i < cookies.length; i++) {
			...
			cookie.put(temp.getName(), temp.getValue());
		}
		this.cookies=cookie;
	}
